...
class LocationClient {
  static List<Location> _items = [
    ...
    Location(
        name: 'Mount Fuji',
        url:
            'https://www.japan-guide.com/g18/740/6901_01.jpg',
        facts: <LocationFact>[
          LocationFact(
              title: 'Summary',
              text:
    ...
    Location(
        name: 'Odaiba',
        url:
            'https://rimage.gnst.jp/livejapan.com/public/article/detail/a/00/02/a0002644/img/basic/a0002644_main.jpg?20191017172552',
        facts: <LocationFact>[
          LocationFact(
              title: 'Summary',
              text:
  ...
  static Location fetchOne() {
    return LocationClient._items[0];
  }

  static List<Location> fetchAll() {
    return LocationClient._items;
  }
}
